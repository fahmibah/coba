...
class NostalgiaForInfinityNext(IStrategy):
    ...
    def sell_recover(self, current_profit: float, last_candle, max_loss: float) -> tuple:
        ...
        def sell_r_1(self, current_profit: float, max_profit: float, max_loss: float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        if 0.02 > current_profit >= 0.01:
            ...
            elif (last_candle['rsi_14'] < 38.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 43.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 44.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 45.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 46.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 42.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 41.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 40.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
            ...
            elif (last_candle['rsi_14'] < 39.0) and (last_candle['r_480_1h'] > -20.0) and (last_candle['moderi_96'] == False):
    ...
    def custom_sell(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        sell, signal_name = self.sell_r_1(current_profit, max_profit, max_loss, last_candle, previous_candle_1, trade, current_time)
        if sell and (signal_name is not None):
            return f"{signal_name} ( {buy_tag} )"
